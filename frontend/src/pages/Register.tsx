      ...
      <div className="hidden lg:flex w-1/2 bg-[#f0f4ff] relative overflow-hidden flex-col justify-center px-16 xl:px-24 border-r border-indigo-100/50">
        ...
        <div className="relative z-10 flex flex-col">
          ...
          <p className="text-[17px] leading-[1.75] text-slate-500 font-medium max-w-lg">
            Create an account to track your routes, manage your personal
            profile, and experience seamless mobility with Aila right by your
            side.
          </p>
        </div>
          ...
          <div className="w-full max-w-[420px] relative z-10 mt-12 lg:mt-0">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button
                ...
                disabled={loading}
                style={{ fontFamily: '"Sora", sans-serif' }}
                className="w-full py-4 mt-6 bg-[#0d1f5c] hover:bg-indigo-600 text-white text-[15px] font-extrabold rounded-xl disabled:opacity-50 transition-all shadow-lg shadow-indigo-900/20"
              >
